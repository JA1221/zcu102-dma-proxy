...
int main(int argc, char *argv[])
{
	...
	int num_transfer = atoi(argv[1]);
	int time_diff, trans_size;
	double mb_sec;
	...
	*/
	...
	trans_size = num_transfer*test_size;
	mb_sec = (double)trans_size * ((double)1000000 / 1024 / 1024) / (time_diff);
	printf("Transfer size: %f KB\n", (double)trans_size / 1024);
